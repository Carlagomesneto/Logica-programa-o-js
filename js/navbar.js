...
nav.classList.add('menu-na vegacao');
nav.appendChild(criaUlNav(a ncoras));
...
document.querySelector('[href="/css/responsividade.css"]').
insertAdjacentElement('beforebegin' , linkNavbar);
